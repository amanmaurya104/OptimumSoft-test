...
export const WhatsApp = ({ size, style }: { size?: number; style?: React.CSSProperties }) => (
  <svg width={size || 24} height={size || 24} viewBox="0 0 24 24" fill="currentColor" style={style}>
...
export const X = ({ size, style }: { size?: number; style?: React.CSSProperties }) => (
  <svg width={size || 20} height={size || 20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={style}>
...
export const Send = ({ size, style }: { size?: number; style?: React.CSSProperties }) => (
  <svg width={size || 20} height={size || 20} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={style}>
...
export const MessageCircle = ({ size, style }: { size?: number; style?: React.CSSProperties }) => (
  <svg width={size || 24} height={size || 24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" style={style}>
